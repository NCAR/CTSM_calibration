...
script="/glade/u/home/guoqiang/CTSM_repos/CTSM_calibration/src/MOASMO_support/main_MOASMO_Derecho_part3_newparam_allbasin_emu.py"

iter_end=3

python $script ${iter_end} 18
