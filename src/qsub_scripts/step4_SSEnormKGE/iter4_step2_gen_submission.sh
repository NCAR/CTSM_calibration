...
basin_on_one_node=15 # number of basins in one node
script=/glade/u/home/guoqiang/CTSM_repos/CTSM_calibration/src/MOASMO_support/main_emulator_part2_submission_SSE.py
