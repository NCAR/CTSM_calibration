...
do
  ...
  configfile="/glade/work/guoqiang/CTSM_cases/CAMELS_Calib/Calib_all_HH_MOASMO/configuration/${level}-${basin_number}_config.toml"
  
  # Command to be added
  cmd="python $script $configfile"

  # File to write to
  cmdfile="${cmdpath}/create_cases_part${file_count}.txt"
