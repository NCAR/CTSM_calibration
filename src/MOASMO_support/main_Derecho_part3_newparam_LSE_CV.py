...
import pandas as pd
import numpy as np
from MOASMO_parameter_allbasin_emulator import allbasin_emulator_CV_traintest_and_optimize_2
...
if 'spaceCV' in trainmode:
    allbasin_emulator_CV_traintest_and_optimize_2(infile_basin_info, infile_param_info, infile_attr_foruse, inpath_moasmo, outpathname, path_CTSM_case_all, iter_end, ncpus, suffix, train_index, numruns=numruns, objfunc=objfunc)
