...
allbasin_emulator_train_and_optimize(infile_basin_info, infile_param_info, infile_attr_foruse, inpath_moasmo, path_CTSM_case, iter_end, ncpus, numruns)
...
for tarbasin in range(627):
    config_file = f'{path_CTSM_case}/configuration/_level1-{tarbasin}_config_MOASMO.toml'
