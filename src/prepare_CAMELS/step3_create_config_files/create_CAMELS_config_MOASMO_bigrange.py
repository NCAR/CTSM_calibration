...
for basin_num in range(627):
    ...
    outpath_case = '/glade/work/guoqiang/CTSM_CAMELS/Calib_HH_MOASMO_bigrange'
    outpath_out = '/glade/derecho/scratch/guoqiang/CTSM_outputs/CAMELS_Calib/Calib_HH_MOASMO_bigrange'
    ...
    # if basin_num != 0:
    #     if not df_cluster.iloc[basin_num]["clusters"] == tarcluster:
    #         print('The basin is not within the target cluster. skip it')
    #         continue
    ...
    config_calib['files']['path_calib'] = f"/glade/campaign/cgd/tss/people/guoqiang/CTSM_CAMELS_proj/Calib_HH_MOASMO_bigrange/{level}_{basin_num}_MOASMOcalib" # if not provided, just use default settings (i.e., a folder within the same folder with the CTSM case)
    ...
    config_calib['settings']['num_per_iter'] = 40 # number of selected pareto parameter sets for each iteration
