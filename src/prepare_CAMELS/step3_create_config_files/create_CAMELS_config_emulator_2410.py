...
for basin_num in range(627):
    ...
    outpath_case = '/glade/work/guoqiang/CTSM_CAMELS/Calib_HH_emulator'
    outpath_out = '/glade/derecho/scratch/guoqiang/CTSM_outputs/CAMELS_Calib/Calib_HH_emulator'
    ...
    config_CTSM['files']['file_CTSM_ROFMESH'] = f'/glade/work/guoqiang/CTSM_CAMELS/data_mosart/CAMELS_{level}_{basin_num}_0.125nldas2_ESMFmesh.nc'
    ...
    frivinp_rtm = f'/glade/work/guoqiang/CTSM_CAMELS/data_mosart/CAMELS_{level}_{basin_num}_MOSART_routing_0.125nldas2.nc'
    
    config_CTSM['AddToNamelist']['user_nl_mosart'] = ["rtmhist_fincl2 = 'RIVER_DISCHARGE_OVER_LAND_LIQ', 'RIVER_DISCHARGE_OVER_LAND_ICE'", 
                                                     "rtmhist_nhtfrq = 0, -24",
                                                     "rtmhist_mfilt  = 12, 365",
                                                     f"frivinp_rtm = '{frivinp_rtm}'",
                                                     ]
    ...
    config_calib['files']['path_calib'] = f"/glade/campaign/cgd/tss/people/guoqiang/CTSM_CAMELS_proj/Calib_HH_emulator/{level}_{basin_num}_calib" # if not provided, just use default settings (i.e., a folder within the same folder with the CTSM case)
    ...
    config_calib['settings']['num_per_iter'] = 50 # number of selected pareto parameter sets for each iteration
    config_calib['settings']['num_iter'] = 9 # including the initial iteration
