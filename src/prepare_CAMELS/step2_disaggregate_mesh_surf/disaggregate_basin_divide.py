...
for level in [1, 2, 3]:
    ...
    infile_basins = f'/glade/work/guoqiang/CTSM_cases/CAMELS_Calib/data_mesh_surf/HillslopeHydrology/sfcdata/surfdata_CAMELS_level{level}_hist_78pfts_CMIP6_simyr2000_c23111{5+level-1}.nc'
    os.makedirs(outpath, exist_ok=True)
