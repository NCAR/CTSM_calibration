...
config_file="/glade/u/home/guoqiang/CTSM_repos/CTSM_calibration/src/CTSM_config_optmz/one_basin_exps/data_level1_4/exp2/_level1-4_config_MOASMO.toml"
...
do
    ...
    # Run the model
    file=/glade/campaign/cgd/tss/people/guoqiang/CTSM_CAMELS_proj/MOASMO_exps/level1_4_exp2/run_model_normKGE/iter${i}/commands_run_iter${i}.txt
    if [ $i -eq 0 ]; then  # Corrected syntax for the conditional statement
        file=/glade/campaign/cgd/tss/people/guoqiang/CTSM_CAMELS_proj/MOASMO_exps/level1_4_exp2/run_model/iter${i}/commands_run_iter0.txt
    fi
    ...
    if [ $i -eq 0 ]; then
        mv /glade/campaign/cgd/tss/people/guoqiang/CTSM_CAMELS_proj/MOASMO_exps/level1_4_exp2/ctsm_outputs /glade/campaign/cgd/tss/people/guoqiang/CTSM_CAMELS_proj/MOASMO_exps/level1_4_exp2/ctsm_outputs_normKGE
    fi
