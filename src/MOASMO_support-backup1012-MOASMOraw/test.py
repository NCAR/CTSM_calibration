...
#     basin_num = 627
    ...
    tasks = []
    for basin in range(221, 222):
        print('basin', basin)
        configfile = f'/glade/u/home/guoqiang/CTSM_repos/CTSM_calibration/src/CTSM_config_optmz/one_basin_exps/data_level1_221/exp2/_level1-{basin}_config_MOASMO.toml'

        pattern = f'/glade/campaign/cgd/tss/people/guoqiang/CTSM_CAMELS_proj/MOASMO_exps/level1_221_exp2/ctsm_outputs_normKGE/iter0_trial*'
