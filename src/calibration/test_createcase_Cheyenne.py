...
path_CTSM_case = f'/glade/work/guoqiang/CTSM_cases/CAMELS_Calib/test/CAMELS_{bnum}'
path_CTSM_CIMEout = f'/glade/scratch/guoqiang/CTSM_outputs/CAMELS_Calib/test/CAMELS_{bnum}'
