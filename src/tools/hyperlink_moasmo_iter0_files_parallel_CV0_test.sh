...
process_iteration() {
  ...
  dst_dir="/glade/campaign/cgd/tss/people/guoqiang/CTSM_CAMELS_proj/Calib_HH_emulator/level1_${i}_calib/param_sets_LSEnormKGECV0test"
  create_symlinks "$src_dir" "$dst_dir" "iter0_trial0"
