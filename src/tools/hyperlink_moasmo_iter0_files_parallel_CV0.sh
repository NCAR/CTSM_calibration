...
process_iteration() {
  ...
  # # Skip if i is a multiple of 5
  # if (( i % 5 == 0 )); then
  #   echo "Skipping iteration $i (multiple of 5)"
  #   return
  # fi

  src_dir="/glade/campaign/cgd/tss/people/guoqiang/CTSM_CAMELS_proj/Calib_HH_emulator/level1_${i}_calib/ctsm_outputs"
  dst_dir="/glade/campaign/cgd/tss/people/guoqiang/CTSM_CAMELS_proj/Calib_HH_emulator/level1_${i}_calib/ctsm_outputs_LSEnormKGECV0"
  ...
  dst_dir="/glade/campaign/cgd/tss/people/guoqiang/CTSM_CAMELS_proj/Calib_HH_emulator/level1_${i}_calib/param_sets_LSEnormKGECV0"
  create_symlinks "$src_dir" "$dst_dir" "iter0"
...
# Parallel execution
parallel -j 30 process_iteration ::: {0..626..5}
