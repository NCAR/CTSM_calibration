...
merge_files() {
    ...
    local path0="/glade/campaign/cgd/tss/people/guoqiang/CTSM_CAMELS_proj/LongTermSimu/DDS"
...
for normKGE in normKGEr1; do
    seq 0 5 626 | parallel -j 36 merge_files {} $normKGE
done
