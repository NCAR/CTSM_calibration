...
if __name__ == '__main__':
    ...
    for basin in range(basin_num):
        print('basin', basin)
        configfile = f'/glade/work/guoqiang/CTSM_CAMELS/Calib_HH_emulator/configuration/_level1-{basin}_config_MOASMO.toml'
        # folder = f'/glade/campaign/cgd/tss/people/guoqiang/CTSM_CAMELS_proj/LongTermSimu/Defa/level1_{basin}'
        # tasks.append((folder, configfile))
        # for i in range(2, 6):
        for i in [1]:
            folder = f'/glade/campaign/cgd/tss/people/guoqiang/CTSM_CAMELS_proj/Calib_HH_emulator_LongTermSimu/LSEallbasin/level1_{basin}/normKGEr{i}'
            tasks.append((folder, configfile))
